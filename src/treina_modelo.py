...
def treina_avalia_modelo(df_features):
    ...
    modelo_sil = RandomForestClassifier(n_estimators=100, random_state=42)
    ...
    previsoes = modelo_sil.predict(X_teste)
    ...
    return modelo_sil, X_teste, y_teste, previsoes, acuracia, class_report
